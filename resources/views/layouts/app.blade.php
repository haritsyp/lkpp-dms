...
<body>
	<section class="body">
		...
		<div class="inner-wrapper">
			<aside id="sidebar-left" class="sidebar-left" style="height: 100%">
					...
					<div class="nano-content">
						<nav id="menu" class="nav-main" role="navigation">
							<ul class="nav nav-main">
								...
								<li>
									<a href="{{ url('standartlkpp') }}">
										<i class="fa fa-wpforms" aria-hidden="true"></i>
										<span>Form Standart LKPP</span>
									</a>                        
								</li>
								<li>
									<a href="{{ url('user') }}">
								...
								<li>
									<a href="{{ url('doctipe') }}">
										<i class="fa fa-wpforms" aria-hidden="true"></i>
										<span>Document Tipe</span>
									</a>                        
								</li>
								@endif		
								@if(session('level') == 'petugas' || session('level') == 'admin')

								@foreach($standar as $h)
								<li>
									<a href="{{ url('lkpp/detail/'.$h->standartid) }}">
										<i class="fa fa-wpforms" aria-hidden="true"></i>
										<span>{{ $h->row_number }}. {{ $h->standartname }}</span>
									</a>                        
								</li>
								@endforeach		
								@endif
